...
export default function ProductDeleteModal({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger className="relative cursor-pointer w-full text-left select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden transition-colors hover:bg-primary-100 hover:text-primary-900 dark:focus:bg-slate-800 dark:focus:text-slate-50">
        {children}
      </DialogTrigger>
